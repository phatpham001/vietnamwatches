...
namespace VietnamWatches.Areas.Admin.Controllers
{
    public class ContactController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FullName,Email,Phone,Title,Detail,ReplayDetail,CreatedBy,CreatedAt,UpdatedBy,UpdatedAt,Status")] Contact contact)
        {
            if (ModelState.IsValid)
            {
